...
After tool calls, interpret the results and answer the actual question. Never dump raw JSON. Highlight relevant limits, exclusions, deductibles, and differences. State that provider data and quotes are illustrative.
"""
