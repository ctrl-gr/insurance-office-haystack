...
async def compare_quotes(age: int, coverage_type: str, asset_value: float) -> dict:
    arguments = {"client_age": age, "coverage_type": coverage_type, "asset_value": asset_value}
...
async def purchase_policy(provider_id: str, annual_premium: float, quote_id: str | None = None) -> dict:
    arguments = {"annual_premium": annual_premium}
    if quote_id:
